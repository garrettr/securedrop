...
If you do encounter issues booting Ubuntu on the NUCs, try [updating the BIOS](http://arstechnica.com/gadgets/2014/02/new-intel-nuc-bios-update-fixes-steamos-other-linux-booting-problems/).
